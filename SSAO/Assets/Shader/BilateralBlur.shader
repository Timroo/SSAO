Shader "SSAO/BilateralBlur"
{
    // 通过两个 Pass：水平（horizontal）+ 垂直（vertical）模糊
    SubShader
    {
        ...
        {
            // dot(nor1,nor2)越接近1，表示越相似
            // _BilaterFilterFactor法线相似性阈值
        ...
        half4 frag(v2f i) : SV_Target
        {
            ...
            // float w = 0.37004405286;
            // float w0a =  0.31718061674;
            // float w0b =  0.31718061674;
            // float w1a =  0.19823788546;
            // float w1b =  0.19823788546;
            // float w2a =  0.11453744493;
            // float w2b =  0.11453744493;
